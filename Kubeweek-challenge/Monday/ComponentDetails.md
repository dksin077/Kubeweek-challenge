...
#### Service:-
- The main purpose of service is to provide a stable IP(ClusterIP) address or DNS name, that's makes communication very easy between the pods, even as Pods are created, destroyed, or replaced.
- Types of Servies
